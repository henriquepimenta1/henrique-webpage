      ...
      <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr",
        ...
        <div>
          <p style={{ fontFamily:"var(--font-serif)", fontStyle:"italic", fontSize:26,
            letterSpacing:"-.01em", lineHeight:1.25, maxWidth:"22ch", margin:"0 0 16px" }}>
            Fotografia de campo, feita com os pés no chão.
          </p>
          <span style={{ fontFamily:"var(--font-hand)", fontSize:30,
            color:"var(--rust-soft)", transform:"rotate(-2deg)",
            display:"inline-block", lineHeight:1 }}>— Henrique</span>
        </div>
        ...
        <div>
          ...
          <a href="https://wa.me/5511988128064" style={{ display:"block", fontSize:13,
            lineHeight:2, color:fg, textDecoration:"none", opacity:.8 }}>WhatsApp</a>
          <a href="https://instagram.com/henriq.eu" style={{ display:"block", fontSize:13,
            lineHeight:2, color:fg, textDecoration:"none", opacity:.8 }}>Instagram</a>
        </div>

        {/* Col 4 — Base */}
        <div>
          <p style={{ fontFamily:"var(--font-mono)", fontSize:10, letterSpacing:".22em",
            textTransform:"uppercase", color:dim, marginBottom:14, marginTop:0 }}>Base</p>
